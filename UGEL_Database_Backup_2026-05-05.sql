...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Registro de auditoría de actividades de usuarios';
...
INSERT INTO `auditoria_logs` VALUES (2,1,'Sustentos PDF','DESCARGAR','Visualizó/Descargó el archivo Caso-Practico-Implementacion.pdf','2026-04-26 04:47:28','::1'),(3,1,'Administración','DESCARGAR','El administrador generó y descargó un Backup de la BD (backup_ugel_db_2026-04-26T17-17-16.sql)','2026-04-26 17:17:17','::1');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Egresos registrados por directores';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Ingresos registrados por directores';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ingresos` VALUES (5,4,'2026-01-20','FACTURA','001','ESTO ES UNA PRUEBA DE FACTURA',10.00,'2026-04-06 01:43:14','2026-04-06 01:43:14'),(7,1,'2026-04-14','FACTURA','011','ESTO ES UNA PRUEBA DE FACTURA',550.00,'2026-04-07 04:31:16','2026-04-07 04:31:16'),(8,1,'2026-02-02','Boleta','001','ESTO ES UNA PRUEBA DE BOLETA',60.00,'2026-04-19 22:55:23','2026-04-19 22:55:23'),(9,1,'2026-02-10','Factura','005','ESTO ES UNA PRUEBA DE FACTURA',80.00,'2026-04-19 22:55:23','2026-04-19 22:55:23'),(10,1,'2026-03-19','Factura','100','prueba',1000.00,'2026-04-19 22:55:39','2026-04-19 22:55:39'),(17,1,'2026-01-10','Factura','010','ESTO ES UNA PRUEBA DE FACTURA',100.00,'2026-04-22 04:55:45','2026-04-22 04:55:45'),(18,1,'2026-01-19','Factura','011','Esto es una factura de colegio xyx',300.00,'2026-04-22 04:55:45','2026-04-22 04:55:45');
...
INSERT INTO `instituciones_educativas` VALUES (1,'0359323','FE Y ALEGRIA 42','primaria','especial','SANTA','CHIMBOTE','2026-04-05 17:01:59','2026-04-05 17:01:59'),(2,'0495234','FE Y ALEGRIA 14','secundaria','regular','SANTA','CHIMBOTE','2026-04-05 17:01:59','2026-04-05 17:01:59'),(3,'0577098','FE Y ALEGRIA 16','secundaria','regular','SANTA','CHIMBOTE','2026-04-05 17:01:59','2026-04-05 17:01:59'),(4,'0686600','88227 PEDRO PABLO ATUSPARIA','secundaria','regular','SANTA','NUEVO CHIMBOTE','2026-04-05 17:01:59','2026-04-05 17:01:59'),(5,'0359356','INMACULADA DE LA MERCED','secundaria','regular','SANTA','CHIMBOTE','2026-04-05 17:01:59','2026-04-05 17:01:59'),(6,'0570226','01 CHIMBOTE','primaria','especial','SANTA','CHIMBOTE','2026-04-05 17:01:59','2026-04-05 17:01:59');
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Auditoría de logins - histórico de accesos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Saldos mensuales de la cuenta corriente por trimestre';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `saldos_cuenta_corriente` VALUES (2,1,2026,1,2079.70,5268.30,7724.10,2948.50,'2026-04-19 23:11:39','2026-04-19 23:11:39');
...
INSERT INTO `usuarios` VALUES (1,'sariber19@hotmail.com',NULL,'$2a$10$rio.F9w0kSQJHcbfKTcI5uyV0BS6wfa1gdTTjkCqmEg5zH/vbfS2K',0,'director',1,'activo','2026-05-05 20:33:46','2026-04-05 17:01:59','2026-05-05 20:33:46',NULL,NULL),(2,'custodioviera1967@hotmail.com',NULL,'$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',1,'director',2,'activo',NULL,'2026-04-05 17:01:59','2026-04-05 17:28:34',NULL,NULL),(3,'',NULL,'$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',1,'director',3,'activo',NULL,'2026-04-05 17:01:59','2026-04-05 17:28:34',NULL,NULL),(4,'yedadero@hotmail.com',NULL,'$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',1,'director',4,'activo',NULL,'2026-04-05 17:01:59','2026-04-05 17:28:34',NULL,NULL),(5,'carolinarospigliosi@hotmail.com',NULL,'$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',1,'director',5,'activo',NULL,'2026-04-05 17:01:59','2026-04-05 17:28:34',NULL,NULL),(6,'daryexpaxmo@hotmail.com',NULL,'$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',1,'director',6,'activo',NULL,'2026-04-05 17:01:59','2026-04-05 17:28:34',NULL,NULL),(7,'especialista@ugel.edu.pe','William M. Benites Pimentel','$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',0,'especialista',NULL,'activo','2026-05-05 21:48:08','2026-04-05 17:01:59','2026-05-05 21:48:08',NULL,NULL),(8,'edu.venegas@ugel.edu.pe','Edgard Venegas','$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',0,'admin',NULL,'activo','2026-05-05 21:48:24','2026-04-25 17:46:28','2026-05-05 21:48:24',NULL,NULL),(9,'brayan.leyva@ugel.edu.pe','Brayan Leyva','$2a$10$zTCEUvETr2o2ug6B0W1DQen7h/WD18BPCdQz36TyVy7q7nHrp2Wci',1,'admin',NULL,'activo','2026-04-26 16:29:42','2026-04-26 16:13:42','2026-04-26 16:29:42',NULL,NULL);
...
-- Dump completed on 2026-05-05 16:48:41
