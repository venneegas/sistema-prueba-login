...
const EgresosView = ({ trimestreMeses, trimestreId, anio, directorId, trimestreCerrado, schoolName }) => {
  ...
  const declararSinMovimientos = async () => {
    if (trimestreCerrado) return;
    if (!window.confirm(`¿Estás seguro de declarar S/. 0.00 de egresos para el mes de ${trimestreMeses[mesActivo]}? Se borrarán las filas actuales si las hubiera.`)) return;
      ...
      <div className="bg-white p-8 rounded-[28px] shadow-[0_24px_60px_-30px_rgba(15,23,42,0.45)] border border-slate-200">
        ...
        <div className="flex justify-between items-center mb-6 rounded-3xl border border-slate-300 bg-slate-50/80 p-5 shadow-sm">
          <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wide">
            RELACIÓN DE EGRESOS - {trimestreMeses[mesActivo].toUpperCase()} {anio}
          </h2>
